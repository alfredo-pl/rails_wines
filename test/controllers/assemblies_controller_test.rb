...
class AssembliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assembly" do
    assert_difference('Assembly.count') do
      post assemblies_url, params: { assembly: { strain_id: @assembly.strain_id, wine_id: @assembly.wine_id } }
    end
  ...
  test "should update assembly" do
    patch assembly_url(@assembly), params: { assembly: { strain_id: @assembly.strain_id, wine_id: @assembly.wine_id } }
